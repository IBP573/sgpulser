...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/sgpulser<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sgpulser) Block Dash 1v1",
      descriptionKey: "Practice your skills in the Stumble Pulser TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sgpulser) Block Dash Legendary 1v1",
      descriptionKey: "Practice your skills in the Stumble Pulser TournamentX! mode!",
